...
preprocessing.py - Препроцессинг исходных данных

training_inference.py - Модуль для обучения и инференса

evaluate.py - Модуль для оценки качества модели
...
Для фильтрации классов с низкими метриками мы использовали порог по вероятности th=0.8.
В итоге 68% примеров(p<0.8) по данным классам разделились и к ним в последствии мы применяли регулярные выражения.
